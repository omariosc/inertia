...
class Authentication(unittest.TestCase):
    ...
    def test_authentication(self):
        self.client.debug_remove_account('invalid@inertia')
        self.client.signup('invalid@inertia', 'Test Account', 'thegate')
    ...
    def test_profile(self):
        self.client.debug_remove_account('invalid@inertia')
        self.client.signup('invalid@inertia', 'Test Account', 'thegate')
        login_response = self.client.login('invalid@inertia', 'thegate')
